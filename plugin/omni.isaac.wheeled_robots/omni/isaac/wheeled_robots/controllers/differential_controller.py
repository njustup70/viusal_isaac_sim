...
class OgnSteeringControl:
    ...
    def compute(db) ->bool:
        ...
        try:
            ...
            max_rotational_speed = db.inputs.max_rotational_speed
            ...
            # Set outputs
            # db.outputs.position_command = motor_angle
            # db.outputs.velocity_command = motor_speed
            motor_speed=np.clip(motor_speed, -max_rotational_speed, max_rotational_speed)
            db.outputs.velocity_command = motor_speed
            return True
