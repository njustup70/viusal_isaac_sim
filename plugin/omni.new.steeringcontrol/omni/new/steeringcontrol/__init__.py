...
class OmniNewSteeringcontrolExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.new.steeringcontrol] OmniNewSteeringcontrolExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.new.steeringcontrol] OmniNewSteeringcontrolExtension shutdown", flush=True)
